//TO DO
// 1. select all the drum elements and add event listener
// 2. add animation when a button is clicked
// 3. play music
...
const api_call = () => {
    ...
    fetch(URL,{
        headers: {
            'Authorization': 'Client-ID _B6gTvjjluWJhDlsfEhvFyZAuq1ahF-yO_jTRW_sYJU'
        }
    }).then(res=>res.json())
    .then(res => {
...
//theme 2
const theme_2__background = "#ADD8E6";
